...
DXHDCP_SYMLINKS := $(addprefix $(TARGET_OUT_ETC)/firmware/,$(notdir $(DXHDCP_IMAGES)))
$(DXHDCP_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "DXHDCP firmware link: $@"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf /firmware/image/$(notdir $@) $@

ALL_DEFAULT_INSTALLED_MODULES += $(DXHDCP_SYMLINKS)
